...
DROP DATABASE IF EXISTS onlinestore_test;
CREATE DATABASE onlinestore_test OWNER manager LOCALE 'en_US.utf8' ENCODING 'SQL_ASCII' TEMPLATE template0;

\l
ALTER SYSTEM SET default_transaction_isolation = 'serializable';
GRANT ALL PRIVILEGES ON DATABASE onlinestore TO manager;
GRANT ALL PRIVILEGES ON DATABASE onlinestore_test TO manager;
